...
const Listing = () => {
    ...
    return (
        <main>
            {loading && <p className='text-slate-700 text-center my-7 text-3xl'>Loading...</p>}
            {error && <p className='text-red-700 text-center my-7 text-3xl'>Something went wrong, Try again!!</p>}
